...
public class vehicleSearchDetailsActivity extends AppCompatActivity {
    ...
    private String vehicle_id, vehicle_name, vehicle_type, vehicle_pkc, state, city, url, user_id;
    ...
    private void getUserDetail() {
        ...
        String url = "http://ec2-35-167-97-234.us-west-2.compute.amazonaws.com:8080/api/" + user_id + "/getUserProfileData";
    ...
    public void quote(View view) {
        ...
        tv_state_value.setVisibility(View.VISIBLE);
        tv_city_value.setVisibility(View.VISIBLE);
        tv_city.setVisibility(View.VISIBLE);
        findViewById(R.id.quoteButton).setVisibility(View.INVISIBLE);
