...
public class vehicleDetailsActivity extends AppCompatActivity {
    ...
    private String vehicle_name, vehicle_type, vehicle_pkc, state, city, url, vehicle_id;
    ...
    public void deleteVehicle(View view){
        ...
        String url = "http://ec2-35-167-97-234.us-west-2.compute.amazonaws.com/api/" + vehicle_id + "/deleteVehicleEntry";
