...
public class vehicleListItem {
    ...
    public vehicleListItem(String heading, String perkm, String imageUrl, String VehicleID, String UserID, String vehicleType, String state, String city, String verified) {
